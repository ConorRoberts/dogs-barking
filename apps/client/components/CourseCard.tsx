...
const CourseCard = (props : CourseCardProps) => {
  ...
  return (
    <div className="py-1 m-6 flex flex-row bg-neutral-200 place-content-center place-self-center mx-5 my-2 rounded-lg w-4/5">
      ...
      <div className=" flex flex-col w-1/4 h-full place-self-center place-content-center pr-2">
        {/* Add onClick call here, probably generate URL from the courseCode. */}
        <button onClick={addSemesterClick} className="h-12 w-20 place-self-end text-white rounded-md bg-green-500 hover:bg-green-400">
          +
        </button>
      </div>
    </div>
