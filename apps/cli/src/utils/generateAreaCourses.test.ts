...
import generateAreaCourses from ".";
...
test("One course found", () => {
    expect(generateAreaCourses(cisSection, courses)).toEqual(expectedCourses);
});


test("No course found", () => {
    expect(generateAreaCourses(fakeSection, courses)).toEqual([]);
});