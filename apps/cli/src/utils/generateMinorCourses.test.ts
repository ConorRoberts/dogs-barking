...
import generateMinorCourses from ".";
...
test("One course found", () => {
    expect(generateMinorCourses(cisSection, courses)).toEqual(expectedCourses);
});


test("No course found", () => {
    expect(generateMinorCourses(fakeSection, courses)).toEqual([]);
});