      ...
      <div>
        <div className="flex gap-4 flex-wrap justify-center">
          <div className="bg-white dark:bg-gray-800 shadow-center rounded-md py-12 px-4 flex flex-col gap-4 w-80">
            <SearchIcon size={60} className="text-gray-800 dark:text-gray-100 mx-auto" />
            <div>
          ...
          <div className="bg-white dark:bg-gray-800 shadow-center rounded-md py-12 px-4 flex flex-col gap-4 w-80">
            <PlannerIcon size={60} className="text-gray-800 dark:text-gray-100 mx-auto" />
            <div>
          ...
          <div className="bg-white dark:bg-gray-800 shadow-center rounded-md py-12 px-4 flex flex-col gap-4 w-80">
            <EmptyStarIcon size={60} className="text-gray-800 dark:text-gray-100 mx-auto" />
            <div>
