...
import getProgramCourses from "./getPrerequisites";



//TO DO
const createProgramGraph = async (nodeId: string) => {
  const nodes = [];
  try {
    const data = await getProgramCourses(nodeId);
...
export default createProgramGraph;
